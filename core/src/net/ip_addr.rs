...
/// assert!("012.004.002.000".parse::<Ipv4Addr>().is_err()); // 所有八位组都是八进制
/// assert!("0000000.0.0.0".parse::<Ipv4Addr>().is_err()); // 第一个八位组是八进制的 0
/// assert!("0xcb.0x0.0x71.0x00".parse::<Ipv4Addr>().is_err()); // 所有八位组都是十六进制
/// ```
